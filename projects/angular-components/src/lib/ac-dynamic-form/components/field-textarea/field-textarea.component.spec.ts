...
describe('FieldTextareaComponent', () => {
  ...
  beforeEach(() => {
    ...
    fixture.componentInstance.field = {type: 'textarea', name: 'textareaName'};
    fixture.componentInstance.group = new FormGroup({textareaName: new FormControl('')});
  ...
  it('should have the class "ac-dynamic-field-textarea"', () => {
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('mat-form-field').classList).toContain('ac-dynamic-field-textarea');
  });

  it('should have readonly defined by field.readonly', () => {
    fixture.componentInstance.field.readonly = true;
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.querySelector('textarea').readOnly).toEqual(true);
  });
  ...
  it('should have the input name defined field.name', () => {
    ...
    const myField = el.querySelector('textarea[ng-reflect-name=textareaName]');
  ...
  it('should have the placeholder defined by field.placeholder', () => {
    ...
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.querySelector('textarea').placeholder).toEqual('placeholderTest');
  });

  it('should have required defined by field.required', () => {
    fixture.componentInstance.field.required = true;
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.querySelector('textarea').required).toEqual(true);
  });
  ...
  describe('StartHint', () => {
    ...
    it('should have a button if an action is defined', () => {
      fixture.componentInstance.field.startHint = {
        label: 'test', action: () => {}, actionAriaLabel: 'test'
      };
      fixture.detectChanges();
      const el = fixture.debugElement.nativeElement;
      const myField = el.querySelector('mat-hint[ng-reflect-align=start] button');

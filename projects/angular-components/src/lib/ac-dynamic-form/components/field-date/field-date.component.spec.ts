...
describe('FieldDateComponent', () => {
  ...
  beforeEach(() => {
    ...
    fixture.componentInstance.field = {type: 'date', name: 'test'};
  ...
  it('should have the class "ac-dynamic-field-date"', () => {
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('mat-form-field').classList).toContain('ac-dynamic-field-date');
  });
  ...
  describe('filterDate', () => {
    ...
    it('if a filter is defined, it should have benn called', async(() => {
      fixture.componentInstance.field.filter = (d: Moment | null, field?: AcFieldDateConfig, group?: FormGroup) => {
        return true;
      };

...
describe('FieldSelectComponent', () => {
  ...
  beforeEach(() => {
    ...
    fixture.componentInstance.field = {type: 'select', name: 'test', options: []};
  ...
  it('should have the class "ac-dynamic-field-select"', () => {
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelector('mat-form-field').classList).toContain('ac-dynamic-field-select');
  });
  ...
  it('should have the select name defined field.name', () => {
    const el = fixture.debugElement.nativeElement;
    const myField = el.querySelector('mat-select[ng-reflect-name=test]');
  ...
  it('should have the placeholder defined by field.placeholder', () => {
    ...
    fixture.detectChanges();
    const el = fixture.debugElement.nativeElement;
    const myField = el.querySelector('mat-select[ng-reflect-placeholder=placeholderTest]');
    expect(myField).toBeTruthy();
  });
  ...
  it('should have required defined by field.required', () => {
    ...
    fixture.detectChanges();
    const el = fixture.debugElement.nativeElement;
    const myField = el.querySelector('mat-select[ng-reflect-required=true]');
    expect(myField).toBeTruthy();
  });

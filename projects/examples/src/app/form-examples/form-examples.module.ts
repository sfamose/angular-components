...
@NgModule({
  declarations: [FormSimpleComponent, MatFormFieldComponent, InputComponent, ValidationsComponent, SelectComponent, TextareaComponent, RadioButtonComponent, DateComponent, TimeComponent, DatetimeComponent, DynamicExampleComponent, CustomInputComponent, InputRatingComponent],
  imports: [
    CommonModule,
